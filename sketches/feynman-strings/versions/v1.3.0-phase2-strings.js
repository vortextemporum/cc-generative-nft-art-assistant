...
const MODES = {
  qed: {
    ...
    elements: ["fermionLine", "photonPropagator", "vertex", "loop", "annihilation", "scattering", "tadpole"]
  },
  qcd: {
    name: "QCD",
  ...
  spinNetwork: {
    ...
    description: "Loop quantum gravity - discrete spacetime structure",
    weight: 0.12,
    particles: ["node", "edge"],
    elements: ["spinNode", "spinEdge", "spinGraph"]
  }
};
